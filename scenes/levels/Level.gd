...
static var all: Array[Level] = [
	...
	Level.new(
		...
		"Tutorial 2",
		"eyJjb29yZGluYXRlX3RvX2Jsb2NrIjp7IntcInhcIjoxLFwieVwiOjN9Ijp7InR5cGUiOjJ9LCJ7XCJ4XCI6NCxcInlcIjo0fSI6eyJjb2xvciI6MCwidHlwZSI6MH19LCJlZGdlcyI6W10sImV4cGVjdGVkX291dHB1dCI6eyJyb3dzIjpbeyIwIjoxLCIxIjowLCIyIjowfV19LCJoZWlnaHQiOjEwLCJ3aWR0aCI6MTB9"
	),
	Level.new(
